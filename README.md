...
[![GoDoc](https://godoc.org/github.com/xxxxxxming/redis?status.svg)](https://godoc.org/github.com/xxxxxxming/redis)
...
- [Pub/Sub](https://godoc.org/github.com/xxxxxxming/redis#PubSub).
- [Transactions](https://godoc.org/github.com/xxxxxxming/redis#example-Client-TxPipeline).
- [Pipeline](https://godoc.org/github.com/xxxxxxming/redis#example-Client-Pipeline) and [TxPipeline](https://godoc.org/github.com/xxxxxxming/redis#example-Client-TxPipeline).
- [Scripting](https://godoc.org/github.com/xxxxxxming/redis#Script).
- [Timeouts](https://godoc.org/github.com/xxxxxxming/redis#Options).
- [Redis Sentinel](https://godoc.org/github.com/xxxxxxming/redis#NewFailoverClient).
- [Redis Cluster](https://godoc.org/github.com/xxxxxxming/redis#NewClusterClient).
- [Cluster of Redis Servers](https://godoc.org/github.com/xxxxxxming/redis#example-NewClusterClient--ManualSetup) without using cluster mode and Redis Sentinel.
- [Ring](https://godoc.org/github.com/xxxxxxming/redis#NewRing).
- [Instrumentation](https://godoc.org/github.com/xxxxxxming/redis#ex-package--Instrumentation).
- [Cache friendly](https://github.com/go-redis/cache).
- [Rate limiting](https://github.com/xxxxxxming/redis_rate).
- [Distributed Locks](https://github.com/bsm/redis-lock).

API docs: https://godoc.org/github.com/xxxxxxming/redis.
Examples: https://godoc.org/github.com/xxxxxxming/redis#pkg-examples.
...
```shell
go get -u github.com/xxxxxxming/redis
```

Import:

```go
import "github.com/xxxxxxming/redis"
```
...
Please go through [examples](https://godoc.org/github.com/xxxxxxming/redis#pkg-examples) to get an idea how to use this package.
